...
import Aucanasta from "../../audio/objetos/canasta.mp3";
import Aubolsa from "../../audio/objetos/bolsa.mp3";

const Objetos = () => {
  return (
    <section>
      <h1 className="text-2xl mb-3 text-white">OBJETOS Y ENTRE OTROS</h1>
      <section>
